...
void Combine() {
  ...
  TString NoShield_GeOnCZT_Signal =
      "01162026-NoShield-GeOnCZT-0_5Percent" + suffix;
  TString NoShield_GeOnCZT_Background =
  ...
  TH1F *zoomedHist_CuShield_01132026_Background =
      static_cast<TH1F *>(file_CuShield_01132026_Background->Get("zoomedHist"));
  ...
  TFile *file_NoShield_GeOnCZT_Signal =
      new TFile("root_files/" + NoShield_GeOnCZT_Signal + ".root", "READ");
  if (!file_NoShield_GeOnCZT_Signal ||
      file_NoShield_GeOnCZT_Signal->IsZombie()) {
    std::cerr << "ERROR: Cannot open " << NoShield_GeOnCZT_Signal << ".root"
              << std::endl;
    return;
  }
  TH1F *hist_NoShield_GeOnCZT_Signal =
      static_cast<TH1F *>(file_NoShield_GeOnCZT_Signal->Get("hist"));
  TH1F *zoomedHist_NoShield_GeOnCZT_Signal =
      static_cast<TH1F *>(file_NoShield_GeOnCZT_Signal->Get("zoomedHist"));

  TFile *file_NoShield_GeOnCZT_Background =
      new TFile("root_files/" + NoShield_GeOnCZT_Background + ".root", "READ");
  if (!file_NoShield_GeOnCZT_Background ||
      file_NoShield_GeOnCZT_Background->IsZombie()) {
    std::cerr << "ERROR: Cannot open " << NoShield_GeOnCZT_Background << ".root"
              << std::endl;
    return;
  }
  TH1F *hist_NoShield_GeOnCZT_Background =
      static_cast<TH1F *>(file_NoShield_GeOnCZT_Background->Get("hist"));
  TH1F *zoomedHist_NoShield_GeOnCZT_Background =
      static_cast<TH1F *>(file_NoShield_GeOnCZT_Background->Get("zoomedHist"));
  ...
  if (Constants::NORMALIZE_BY_TIME) {
    ...
    TH1F *hist_NoShield_GeOnCZT_BkgSubtracted =
        static_cast<TH1F *>(hist_NoShield_GeOnCZT_Signal->Clone(
            "hist_NoShield_GeOnCZT_BkgSubtracted"));
    hist_NoShield_GeOnCZT_BkgSubtracted->Add(hist_NoShield_GeOnCZT_Background,
                                             -1);

    TH1F *zoomedHist_NoShield_GeOnCZT_BkgSubtracted =
        static_cast<TH1F *>(zoomedHist_NoShield_GeOnCZT_Signal->Clone(
            "zoomedHist_NoShield_GeOnCZT_BkgSubtracted"));
    zoomedHist_NoShield_GeOnCZT_BkgSubtracted->Add(
        zoomedHist_NoShield_GeOnCZT_Background, -1);
    ...
    //  zoomedHist_Combined->Add(zoomedHist_CdShield_10_BkgSubtracted);
    ...
    zoomedHist_NoShield_GeOnCZT_BkgSubtracted->Write(
        "zoomedHist_NoShield_GeOnCZT_BkgSubtracted", TObject::kOverwrite);
  ...
  file_NoShield_GeOnCZT_Signal->Close();
  file_NoShield_GeOnCZT_Background->Close();

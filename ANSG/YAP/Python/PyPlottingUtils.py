...
class PyPlottingUtils:
    ...
    def SetROOTStyle(self):
        """Apply the exact ROOT style from your C++ code"""
    ...
    def ConfigureHistogram(self, hist, color, title=""):
        """Configure histogram with your C++ styling"""
        if not hist:
            return
    ...
    def ConfigureCanvas(self, canvas, logy=False):
        """Configure canvas with your C++ styling"""
        if not canvas:
            return
    ...
    def GetDefaultColors(self):
        """Return the exact colors from your C++ code"""
        return [
            ROOT.kRed + 1,
            ROOT.kBlue + 1,
            ROOT.kGreen + 2,
    ...
    def CreateLegend(self, x1=0.6, y1=0.7, x2=0.9, y2=0.85):
        """Create legend with your C++ styling"""
